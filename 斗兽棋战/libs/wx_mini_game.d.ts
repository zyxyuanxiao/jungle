...
declare const wx: {
     ...
     * jacksplwxy:创建登录按钮
     */
    createUserInfoButton(object: Object): void;
    /**
     * jacksplwxy:小游戏跳转
     */
    navigateToMiniProgram(object: Object): void;
    /**
     * jacksplwxy：创建banner广告组
     */
    createBannerAd(object: any)
    /**
     * jacksplwxy：创建游戏圈
     */
    createGameClubButton(object: any)
    /**
     * jacksplwxy:创建激励视频
     */
    createRewardedVideoAd(object: any)
    /**
     ...
     */
    onSocketMessage(Function): void;
    /**
     * 监听WebSocket 错误事件
     */
    onSocketError(Function): void;
    /**
     ...
     * wx.getStorage 的同步版本
     */
    getStorageSync(key: string): Object | string | any;
    /**
     ...
     */
    setStorage(object: { key: string, data: Object | string | any, success?: (res: any) => void, fail?: (res: any) => void, complete?: (res: any) => void }): void;
    /**
     * wx.setStorage 的同步版本
     */
     ...
     * 显示消息提示框
     */
    showToast(object: { title: Object, icon?: Object, image?: Object, duration?: Number, success?: (res: any) => void, fail?: (res: any) => void, complete?: (res: any) => void }): void;
     ...
     */
    onKeyboardConfirm(callback: Function): void;
    /**
     ...
     * 监听监听键盘收起的事件
     */
    onKeyboardComplete(callback: Function): void;
    /**
     * 取消监听监听键盘收起的事件
     */
